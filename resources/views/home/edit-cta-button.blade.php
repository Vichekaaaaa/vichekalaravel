<?php
// resources/views/home/edit-cta-button.blade.php
?>

@extends('layouts.app')

@section('title', 'Edit CTA Button')

@section('content')
    <div class="container">
        <h2 class="mb-4 animate__animated animate__fadeInDown">Edit Call-to-Action Button</h2>
        <form action="{{ route('home.update.cta.button', ['index' => $index]) }}" method="POST">
            @csrf
            @method('PUT')
