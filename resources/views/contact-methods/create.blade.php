...
@section('content')
    <h2 class="mb-4">Add New Contact Method</h2>
    ...
    <form action="{{ route('contact-methods.store') }}" method="POST" id="contactMethodForm">
        @csrf
        <div class="mb-3">
    ...
    @push('scripts')
        <script>
            ...
            // Trigger initial update on page load to handle old input values
            updateFormFields();
        </script>
    @endpush
@endsection